    ...
    if request.POST:
        ...
        if form.is_valid():
            try:
                ...
                successinfo = "上传"
                success = True
                return render(request, 'grade/import.html',{
                    "title":'导入成绩单',
                    'form':form,
...
def classgrades(request):
    ...
    return render(request, 'grade/classgrades.html',{
            "title":'班级成绩',
            'username':username})
...
def index(request):
    username = request.user.username
    print "grade index username=", username
    return render(request, 'grade/grades.html',{
            "title":'同学成绩',
            'username':username})
