...
def comperformance_setup(request):
    ...
    return render(request, 'comperformance/comperformance_setup.html',{
            "title":'综合测评设置',
            'username':username})
...
def comperformance(request):
    ...
    return render(request, 'comperformance/comperformance.html',{
            "title":'综合测评',
            'behaviors':behaviors,
...
def studentcomperformance(request):
    ...
    return render(request, 'comperformance/studentcomperformance.html',{
            "title":'查看综合-同学',
            'behaviors':behaviors,
            'developments':developments,
            'username':username})
...
def classcomperformances(request):
    ...
    return render(request, 'comperformance/classcomperformances.html',{
            "title":'综合测评-班级',
            'username':username})
...
def ajaxclasscomperformances(request):
    ...
    if request.is_ajax():
        try:
            ...
            return HttpResponse(json.dumps([xAxis,series]), content_type='application/json')
        except Exception,e:
            response = 'false'
            traceback.print_stack()
            print e
